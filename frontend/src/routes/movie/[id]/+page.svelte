...
<div
	class="absolute left-0 right-0 top-0 -z-10 h-screen w-screen bg-cover bg-center bg-no-repeat"
	style="
		background-image: 
			linear-gradient(to top, var(--fallback-b1,oklch(var(--b1))) 5%, var(--fallback-b1,oklch(var(--b1) / 0.3))),
